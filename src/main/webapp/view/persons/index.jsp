...
<div class="center">
    <div class="col-main">
            ...
            <div class="wrap-left">
                <div class="wrap-list">
                    ...
                    <div class="m-order">
                        ...
                        <ul>
                            <li><a href="../../../frontpage/person/order.html"><i><img src="../../frontpage/images/pay.png"/></i><span>待付款</span></a></li>
                            <li><a href="../../../frontpage/person/order.html"><i><img src="../../frontpage/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
                            <li><a href="../../../frontpage/person/order.html"><i><img src="../../frontpage/images/receive.png"/></i><span>待收货</span></a></li>
                            <li><a href="../../../frontpage/person/order.html"><i><img src="../../frontpage/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
                            <li><a href="../../../frontpage/person/change.html"><i><img src="../../frontpage/images/refund.png"/></i><span>退换货</span></a></li>
                        </ul>
                    </div>
                    <!--九宫格-->
                    <div class="user-patternIcon">
                        ...
                        <ul>
                            ...
                            <a href="../../frontpage/home/shopcart.html"><li class="am-u-sm-4"><i class="am-icon-shopping-basket am-icon-md"></i><img src="../../frontpage/images/iconbig.png"/><p>购物车</p></li></a>
                            <a href="../../../frontpage/person/collection.html"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="../../frontpage/images/iconsmall1.png"/><p>我的收藏</p></li></a>
                            <a href="../../frontpage/home/home.html"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="../../frontpage/images/iconsmall0.png"/><p>为你推荐</p></li></a>
                            <a href="../../../frontpage/person/comment.html"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="../../frontpage/images/iconsmall3.png"/><p>好评宝贝</p></li></a>
                            <a href="../../../frontpage/person/foot.html"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="../../frontpage/images/iconsmall2.png"/><p>我的足迹</p></li></a>
                        </ul>
                    </div>
                    <!--物流 -->
                        ...
                        <div class="s-content">
                            <ul class="lg-list">
                                ...
                                <li class="lg-item">
                                    <div class="item-info">
                                        <a href="#">
                                            <img src="../../frontpage/images/65.jpg_120x120xz.jpg" alt="抗严寒冬天保暖隔凉羊毛毡底鞋垫超薄0.35厘米厚吸汗排湿气舒适">
                                        </a>
                                    ...
                                    <div class="lg-info">
                                        ...
                                        <div class="lg-detail-wrap">
                                            <a class="lg-detail i-tip-trigger" href="../../../frontpage/person/logistics.html">查看物流明细</a>
                                ...
                                <li class="lg-item">
                                    <div class="item-info">
                                        <a href="#">
                                            <img src="../../frontpage/images/88.jpg_120x120xz.jpg" alt="礼盒袜子女秋冬 纯棉袜加厚 女式中筒袜子 韩国可爱 女袜 女棉袜">
                                        </a>
                        ...
                        <div class="s-content">
                                ...
                                <div class="s-item">
                                    ...
                                    <div class="s-pic">
                                        <a href="#" class="s-pic-link">
                                            <img src="../../frontpage/images/0-item_pic.jpg_220x220.jpg" alt="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" class="s-pic-img s-guess-item-img">
                                        </a>
                                    </div>
                            ...
                            <div class="s-item-wrap">
                                <div class="s-item">
                                    ...
                                    <div class="s-pic">
                                        <a href="#" class="s-pic-link">
                                            <img src="../../frontpage/images/1-item_pic.jpg_220x220.jpg" alt="s925纯银千纸鹤锁骨链短款简约时尚韩版素银项链小清新秋款女配饰" title="s925纯银千纸鹤锁骨链短款简约时尚韩版素银项链小清新秋款女配饰" class="s-pic-img s-guess-item-img">
                                        </a>
                                    </div>
                                    <div class="s-price-box">
                            ...
                            <div class="s-item-wrap">
                                <div class="s-item">
                                    ...
                                    <div class="s-pic">
                                        <a href="#" class="s-pic-link">
                                            <img src="../../frontpage/images/-0-saturn_solar.jpg_220x220.jpg" alt="4折抢购!十二生肖925银女戒指,时尚开口女戒" title="4折抢购!十二生肖925银女戒指,时尚开口女戒" class="s-pic-img s-guess-item-img">
                                        </a>
                                    </div>
                                    <div class="s-price-box">
        ...
        <!--底部-->
        <jsp:include page="../../frontpage/JSPpage/tail.jsp"></jsp:include>
        ...
        <ul>
            ...
            <li class="person">
                ...
                <ul>
                    ...
                    <li> <a href="../person/address.html">收货地址</a></li>
                </ul>
            </li>
            <li class="person">
                <a href="#">我的交易</a>
...
<!--引导 -->
<div class="navCir">
    <li><a href="../../frontpage/home/home.html"><i class="am-icon-home "></i>首页</a></li>
    ...
    <li class="active"><a href="../../../frontpage/JSPpage/index.html"><i class="am-icon-user"></i>我的</a></li>
</div>
</body>
</html>
