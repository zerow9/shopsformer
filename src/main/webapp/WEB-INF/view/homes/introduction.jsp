            ...
            <div class="clearfixRight">
                ...
                <div class="pay">
                    <div class="pay-opt">
                        ...
                        <c:if test="${item.repertoryNumber!=0}">
                            <a href="/collection/getUserConllection"><span
                ...
                <c:if test="${item.repertoryNumber!=0}">
                    <%--添加到收藏--%>
                    <div id="Coco">
                        <button class="addc-1" id="myinput" type="button"><i class="am-icon-star-o"
                                        ...
                                        <div class="am-comment-main">
                                            <header class="am-comment-hd">
                                                <div class="am-comment-meta">
                                                    <a href="javascript:;"
                                                       class="am-comment-author">${fn:substring(discuessDetail.user.userName,0,1)}
                                                        *** (匿名)</a>
                                                    评论于
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li class="am-active"><a
                                                    href="?itemId=${item.itemId}&page=${i.count}">${i.count}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
